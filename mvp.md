...
The system calculates "Service Due" status based on the following threshold table. The script flags a service if *either* the mileage or the time limit is reached.
