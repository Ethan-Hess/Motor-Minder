                    ...
                    {!loading && !error ? (
                        <div className="dashboard-grid">
                            <div className="card-dashboard">
                                <div className="text-size-xl">Total Vehicles</div>
                                <div className="text-size-huge">{totalVehicles}</div>
                            </div>

                            <div className="card-dashboard">
                                <div className="text-size-xl">Total Logged Services</div>
                                <div className="text-size-huge">{totalLoggedServices}</div>
                            </div>

                            <div className="card-dashboard">
                                <div className="text-size-xl">Next Services Due</div>
                                <div className="text-size-huge">{nextServicesDueCount}</div>
                            </div>

                            <div className="card-dashboard">
                                <div className="text-size-xl">Overdue Services Count</div>
